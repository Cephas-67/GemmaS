...
export default function Strands({
  ...
  // On garde toujours les dernières props dans une ref pour pouvoir les lire
  // dans la boucle d'animation sans recréer le contexte WebGL à chaque rerender.
  const propsRef = useRef({} as Required<Omit<StrandsProps, "className" | "style">>);
  propsRef.current = {
    colors,
    count,
    speed,
